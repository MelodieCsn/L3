...
using namespace std;
 ...
 //Affiche tout les éléments d'un vecteur
...
//Affiche tout les éléments de chaque vecteur
...
// Affichage de parcoursProfondeur()
...
//Affiche le nombre de sommet à chaque niveau
...
//On crée les voisins de chaque sommet
